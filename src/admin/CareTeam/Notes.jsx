          ...
          <ul className="menuList">
            <li>
              <NavLink to="#">
                ...
                />
                <div className="body">
                  <h5>{careteamJournal?.clientId[0]?.first_Name}</h5>
                  <p>
          ...
          <Tab.Content>
            <Tab.Pane eventKey="taB1">
              <ul className="TasksList">
                {"wellbeingAssessment" in careteamJournal && (
                  <Fragment>
                    <li>
                ...
                {careteamJournal?.Task?.map((task, index) => {
                  ...
                  if (
                    ...
                    return (
                      <li key={index}>
                        ...
                        <p>
                          {careteamJournal?.forClient} medication{" "}
                          {task?.medName} is due at{" "}
                          <Moment format="LT">
                            {`${careteamJournal?.Date} ${
                              task?.schedule.split(" - ")[0]
                            }:00`}
                  ...
                  return (
                    <li key={index}>
                      ...
                      <p>
                        Please assist {careteamJournal?.forClient} with the{" "}
            ...
            <Tab.Pane eventKey="taB2">
              {careteamJournal?.notesData.length > 0 &&
                careteamJournal?.notesData?.map(({ notesData, _id }) => (
