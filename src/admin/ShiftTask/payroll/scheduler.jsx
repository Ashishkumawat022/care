...
class Basic extends Component {
    ...
    return (
      <>
        <div className="card-body">
          ...
          {
            // console.log(this.state.EditTaskData, "EDITTASKDATA", this.state.EventsArr)
          }
          <div
            className="modal"
            style={{
            ...
            <div className="modal-dialog-lg">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ...
                  {console.log(
                    this.state.showGenericEditShiftTaskUI,
                    this.state.EditGenericShiftData,
                    "showGenericEditShiftTaskUI"
                  )}
  ...
  eventItemPopoverTemplateResolver = (
    ...
    // console.log(schedulerData?.events[0], "eventItemPopoverTemplateResolver")
    return (
          ...
          <Col span={55}>
            ...
            <ul>
              {eventItem?.taskList.map((item, index) => {
                console.log(item, "scheduleritemshifttask");
                if ("medName" in item) {
                  return (
  ...
  slotItemTemplateResolver(
    ...
    // console.log(slot, slotClickedFunc, width, clsName, schedulerData, resourceData, "resourceData,schedulerData,schedulerData")
    return (
