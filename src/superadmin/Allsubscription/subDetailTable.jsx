        ...
        >
            {numSelected > 0 ? (
                ...
                <Typography
                    ...
                    component="div"
                >
                    Included in Subscription (Plan - Add-On - Discount Coupon)
                </Typography>
            )}
...
export default function SubDetailTable(props) {
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">{row.lastBillingDate}</TableCell>
                                            <TableCell align="right">{row.nextBillingDate}</TableCell>
                                        </TableRow>
                                    );
                                })}
                            {emptyRows > 0 && (
