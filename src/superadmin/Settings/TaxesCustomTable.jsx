...
export default function TaxesCustomTable() {
  ...
  const getSetting = () => {
    axios({
      ...
      .then((res) => {
        ...
        setRowData(res?.data?.data?.taxes);
  ...
  function addTaxes() {
    ...
    let config = {
      method: "post",
      url: `${process.env.REACT_APP_SUPERADMIN_BASEURL}/addTaxes`,
      headers: {
          ...
          <Box sx={{ width: "100%" }}>
            <Paper sx={{ width: "100%", mb: 2 }}>
              <EnhancedTableToolbar
                ...
                tableName={"Edit Taxes"}
                selected={selected}
                tableforDeleteActInact={"Taxes"}
