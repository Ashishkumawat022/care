...
const UpdateUserRoleManagement = forwardRef((props, ref) => {
  ...
  function updateStudentData() {
    ...
    if (props.refresh != 0) {
      ...
      const OwnerId = JSON.parse(localStorage.getItem("__csadmin__d"));

      let config = {
        method: "post",
        url: `${process.env.REACT_APP_SUPERADMIN_BASEURL}/editUserSuperadminPanel?adminId=${props.updatedData?._id}&ownerId=${OwnerId?._id}`,
        headers: {
