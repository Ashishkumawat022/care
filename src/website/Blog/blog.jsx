...
//           <NavLink to="/" className="btn readmore">Load More</NavLink>
//           </div>
      ...
      <section className="blogmain_section">
        ...
        <div className="blogmain_body">
          <div className="container">
            <h3>Heading</h3>
            <p>Few lines summary </p>
            <NavLink to="/blog-details" className="btn">
              Read
            </NavLink>
          </div>
        </div>
      ...
      <section className="blog_section">
        <div className="container">
          <div className="row">
            ...
            {rowData.slice(0, 6).map(function (data, index) {
              return (
                <>
                  <div className="col-md-4">
                    <div className="blog_box">
                      <div className="blog_box_img">
                        <img
                          alt=""
                          src={`${process.env.PUBLIC_URL}/images/b2.svg`}
                        />
                      </div>
                      <div className="blog_box_body">
          ...
          <div className="col-md-4">
            ...
            <div className="col-md-12 text-center">
              <NavLink to="/allBlogs" className="btn readmore">
                Load More
              </NavLink>
            </div>
          </div>
